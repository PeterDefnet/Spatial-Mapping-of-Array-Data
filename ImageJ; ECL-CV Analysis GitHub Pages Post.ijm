//Update Comments on 022821

// Instructions: 
// Load Script into Macro Editor. (Accessed by "Plugins" -> "New" -> "Macro")
// Select Language to be IJ1 Macro
// Change name of 'filename_load' to match video name to analyze. 
...
// How to avoid common errors: 
	// Make sure no ROI selections are made on video when starting script.
